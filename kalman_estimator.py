...
def kalman_estimator():
    ...
    #TOPICO PARA OBTENER LOS DATOS DE POSICION
    ...
    with open(abs_path + '/scripts/kalman_data_x.txt', 'a') 
                                             as filehandle:
    	for i in range(data_samples):
            json.dump(x_positions[i], filehandle)
	    filehandle.write("\n")

    with open(abs_path + '/scripts/kalman_data_y.txt', 'a') 
                                             as filehandle:
	for i in range(data_samples):
