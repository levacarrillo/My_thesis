...
int main()
{
	...
	//----------------Antecedentes---------------------
	cout << "\033[1;37m2. Antecedentes\033[0m\n";
	cout << "\033[1;33m	2.1 Robots bípedos\033[0m\n";
	cout << "\033[1;37m	2.2 Aplicaciones en el juego de Futbol Soccer\033[0m\n";
	cout << "\033[1;33m	2.3 Conceptos básicos de visión computacional\033[0m\n";
	cout << "\033[1;33m	2.4 El Filtro de Kalman\033[0m\n";
	cout << "\033[1;37m	2.5 Trabajo relacionado\033[0m\n";
	//-----------Segmentación de imágenes-------------
	cout << "\033[1;37m3. Segmentación de imágenes con base en color\033[0m\n";
	...
	cout << "\033[1;37m	5.1 El robot bípedo Nimbro OP\033[0m\n";
