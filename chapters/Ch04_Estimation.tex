...
\begin{eqnarray*}
x_{1_{k+1}} &=& x_{1_k} + \Delta t x_2 + \omega_1\\ %Modelo1
y_{1_{k+1}} &=& y_{1_k} + \Delta t y_2 + \omega_2\\ %Modelo2
x_{2_{k+1}} &=& x_{2_k} - \Delta t \frac{1}{m}\mu_d m g + \frac{1}{m}F_x + \omega_3\\ %Modelo3
y_{2_{k+1}} &=& y_{2_k} - \Delta t \frac{1}{m}\mu_d m g + \frac{1}{m}F_y + \omega_3 %Modelo4
\end{eqnarray*}
...
\begin{equation}
G = \begin{bmatrix}
0 & 0 \\ %Parcial de modelo1 wrt entrada1  &   Parcial de modelo2 wrt entrada 2
0 & 0 \\ %Parcial de modelo2 wrt entrada1  &   Parcial de modelo2 wrt entrada 2
 1/m & 0 \\ %Parcial de modelo3 wrt entrada1  &   Parcial de modelo3 wrt entrada 2
0 & 1/m
\end{bmatrix}
\label{eq:control_matrix}
\end{equation}
